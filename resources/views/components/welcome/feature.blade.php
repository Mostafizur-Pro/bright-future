<div class="relative">
    <div class="container mx-auto flex justify-center gap-5 -mt-5">
        <!-- Card 1 -->
        <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 p-4">
            <div class="card card-compact bg-base-100 hover:bg-accent hover:text-white shadow-xl -mt-8 hover:-mt-12 pt-20">
                <figure>
